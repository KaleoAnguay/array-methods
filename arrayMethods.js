...
// do your work below!
var nameArray = [];
nameArray.push("Michael", "Anguay");

var moreNumber= genericNumberArray.push(6,7,8,9,10);

var popResult = colors.pop(3);

scrambledWords.reverse(0,4);

phoneNumber.reverse(0,6);
...
var mynewOrders = [{takeOut: "Hawaiian"},{takeOut: "Chinese"}];
var updatedOrders = mynewOrders.concat(orderQueue);
